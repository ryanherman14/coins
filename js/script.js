...
function Coin(){
	...
	this.item_on_page;
	/**function doe slots of things when a coin gets created on the page
	*
	*/
	this.create = function(){
		...
		//store a random x and y position, different for each coin. I'm using sreen width or 500, height of 300:
		this.x = Math.floor(Math.random()*500);
		this.y = Math.floor(Math.random()*300);
		//use those x amf y coordinates in the CSS to position the coins:
	...
	/**function doe slots of things when a coin is removed from the page
	*
	*/
